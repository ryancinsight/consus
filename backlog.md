...
- Status: done; integrator: root/ritk_consumer; delivery: [PR 81](https://github.com/ryancinsight/consus/pull/81), merge `dd058480bfb380dc0d4b572de56b2030da6f3dc4`; updated: 2026-09-21.
...
- Acceptance: the same 18 adversarial tests pass in one integration binary;
  ...
  baseline increase.
- Verification: Atlas scan zero regressions; strict Clippy, formatting and docs
  pass; the single integration binary's nextest run
  `876d4055-51f9-44e5-a795-a971f69b4b50` passes 434/434 with the original
  hostile workloads and value-semantic assertions.

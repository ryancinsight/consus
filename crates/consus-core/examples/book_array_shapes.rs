...
fn main() {
    ...
    assert_eq!(scalar.num_elements(), 1, "empty product of scalar shape is 1");
    println!("scalar: rank={} elements={}", scalar.rank(), scalar.num_elements());
    ...
    println!("103×65 tiled by 10×8 = {:?} chunks (ceil)", &tiling_uneven[..]);

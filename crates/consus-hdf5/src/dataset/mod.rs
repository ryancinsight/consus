...
//! ```text
//! dataset/
//! ├── mod        # StorageLayout, Hdf5Dataset metadata struct
//! ├── layout     # Data layout message parser (0x0008)
//! ├── chunk      # Chunk-level I/O with filter pipeline
//! └── selection  # Selection-to-chunk decomposition
//! ```
...
use consus_core::{ChunkShape, Shape};
